[![tests](https://github.com/ddev/ddev-directus/actions/workflows/tests.yml/badge.svg)](https://github.com/ddev/ddev-directus/actions/workflows/tests.yml) ![project is maintained](https://img.shields.io/maintenance/yes/2025.svg)
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.directus.yaml](docker-compose.directus.yaml) file.
...
3. Globally replace "directus" with the name of your add-on.
4. Add the files that need to be added to a DDEV project to the repository. For example, you might replace `docker-compose.directus.yaml` with the `docker-compose.*.yaml` for your recipe.
